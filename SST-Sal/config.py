...
frames_dir = 'E:/Test/frames/'
# Path to the folder containing the optical flow
optical_flow_dir = 'E:/Test/optical flows/Tartan480x640-M_onnx'
# Path to the folder containing the ground truth saliency maps
gt_dir = 'E:/Test/Saliency Maps/'
...
videos_folder = 'C:/Users/Publi/SST-Sal/video'
